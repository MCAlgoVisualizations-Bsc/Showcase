...
//        assertEquals(0, layout.compute(new Integer[0], Pos.ZERO).length);
//    }
//
//    @Test
...
//        var model = new Integer[] { 9, 1, 4, 7, 7, 2 };
...
//        assertEquals(0, layout.random(new Integer[0], Pos.ZERO).length);
//    }
//
//    // --- helpers ---
//
